...
@section('main-content')
                    ...
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <button class="btn btn-primary btn-sm pull-right" data-toggle="modal"
                                    data-target="#employeeAdd"><i class="material-icons">add_circle</i> Add New
                            </button>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach($allEmployee as $employee)
                                        <tr>
                                            ...
                                            <td class="text-warning"
                                                style="font-weight: bold;"> {{ ucfirst($employee->first_name) }}
                                            ...
                                            <td class="text-primary">
                                                <a href="{{url('employee/single-employee/')}}/{{ Encryption::encodeid($employee->id) }}"><i
    ...
    <div class="modal fade" id="employeeAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                                        ...
                                        @foreach($pendingEmployee as $employee)
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <a href="{{url('employee/employee-add/'.Encryption::encodeId($employee->id))}}">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger btn-sm" type="button" class="btn btn-secondary" data-dismiss="modal">
                        Close
                    </button>
