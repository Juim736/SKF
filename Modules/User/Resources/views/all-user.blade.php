                            ...
                            <div class="table-responsive">
                                <table class="table" id="user_table">
                                    ...
                                    @foreach($allUser as $user)
                                        <tr>
                                            <td>{{ ++$loop->index }} </td>
                                            <td class="text-warning">{{ $user->first_name }}
                                                - {{ $user->last_name }} </td>
                                            ...
                                            <td class="text-primary">
                                                <a href="{{url('user/single-user/')}}/{{ Encryption::encodeid($user->id) }}"><i
                                                            class="material-icons">more</i></a>

                                                @if($user->completed)
                                                    <a href="{{url('user/statuschange-user/')}}/{{ Encryption::encodeid($user->id) }}"><i
